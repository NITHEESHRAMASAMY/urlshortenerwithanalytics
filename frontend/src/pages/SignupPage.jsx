          ...
          <TiltCard glowColor="rgba(16, 185, 129, 0.08)">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-xs text-neutral-400 mt-2">
                Join NexLink to unlock custom aliases and track visitor metrics.
              </p>
            </div>
            ...
            <div className="text-center mt-6 pt-4 border-t border-neutral-800/40 text-xs">
              ...
              <Link to="/login" className="text-emerald-green hover:text-luxury-gold font-bold underline transition-colors">
                Login here
              </Link>
            </div>
